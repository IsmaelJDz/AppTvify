...
(0, _jquery2.default)(function () {
    ...
    */
    ...
    var template = '<article class="tv-show">' + '<div class="left img-container">' + '<img src=":img:" alt=":img alt:">' + '</div>' + '<div class="right info">' + '<h1>:name:</h1>' + '<p>:summary:</p>' + '<button class="like"><3</button>' + '</div>' + '</article>';

    (0, _jquery2.default)('#app-body').find('form').submit(onsubmit);
